functor SolverFn (val coalesce_missings : bool
...
struct
  ...
  fun addprop addtransition table p =
    let
      (* return the index of this prop in the table *)
      fun addgetprop (p : prop) =
        let
          fun findy n =
           ...
           let
             ...
             fun chooseone (choice, rest) =
               (* add transition between
                  ...
                  and
                  rest -> prop *)
               addtransition (i, addprop addtransition table choice,
                              addprop addtransition table (Missing (prop, rest)))
           in
  ...
  fun solve transitions maxsteps invsize (goal : int) pile =
    let
      ...
      val hashtable = Array.array(313373, nil : int list list)
